...
def app():
    ...
    P1.metric(label = "CO",    
              value = round(data[data.lockdown == "lockdown_1"]["('median', 'co')"].mean(), 2), 
              delta = round(data[data.lockdown == "lockdown_1"]["('median', 'co')"].mean() - data["('median', 'co')"].mean(), 4))
    P2.metric(label = "Dew",   
              value = round(data[data.lockdown == "lockdown_1"]["('median', 'dew')"].mean(), 2), 
              delta = round(data[data.lockdown == "No lockdown"]["('median', 'co')"].mean() - data["('median', 'dew')"].mean(), 4))
    P3.metric(label = "NO2",   
              value = round(data[data.lockdown == "lockdown_1"]["('median', 'no2')"].mean(), 2), 
              delta = round(data[data.lockdown == "lockdown_1"]["('median', 'no2')"].mean() - data["('median', 'no2')"].mean(), 4))
    P4.metric(label = "O3",    
              value = round(data[data.lockdown == "lockdown_1"]["('median', 'o3')"].mean(), 2), 
              delta = round(data[data.lockdown == "lockdown_1"]["('median', 'o3')"].mean() - data["('median', 'o3')"].mean(), 4))
    P5.metric(label = "PM10",  
              value = round(data[data.lockdown == "lockdown_1"]["('median', 'pm10')"].mean(), 2), 
              delta = round(data[data.lockdown == "lockdown_1"]["('median', 'pm10')"].mean() - data["('median', 'pm10')"].mean(), 4))
    P6.metric(label = "PM2.5", 
              value = round(data[data.lockdown == "lockdown_1"]["('median', 'pm25')"].mean(), 2), 
              delta = round(data[data.lockdown == "lockdown_1"]["('median', 'pm25')"].mean() - data["('median', 'pm25')"].mean(), 4))
    P7.metric(label = "SO2 ",  
              value = round(data[data.lockdown == "lockdown_1"]["('median', 'so2')"].mean(), 2), 
              delta = round(data[data.lockdown == "lockdown_1"]["('median', 'so2')"].mean() - data["('median', 'so2')"].mean(), 4))
